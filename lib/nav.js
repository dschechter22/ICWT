...
export const SECTIONS = [
  ...
  },
  {
    ...
    featured: { label: 'Sportsbook', href: '/sportsbook', desc: 'Dino Dollars, moneylines, parlays and settled bets' },
    items: [
      ['Sportsbook', '/sportsbook', 'Dino Dollars, moneylines, parlays and settled bets'],
      ['Preweek', '/preweek', 'Stakes, rooting guide and the week’s lines'],
      ['Predictions', '/predictions', 'Weekly lines and season futures'],
      ['Postweek', '/postweek', 'Awards, results and what the week moved'],
    ],
